...
return [
    ...
    'tts' => [
        ...
        ['language' => 'Amharic (Ethiopia)', 'code' => 'am-ET'],
        ['language' => 'Armenian (Armenia)', 'code' => 'hy-AM'],
        ['language' => 'Azerbaijani (Azerbaijan)', 'code' => 'az-AZ'],
        ...
        ['language' => 'English (Ghana)', 'code' => 'en-GH'],
        ['language' => 'English (United Kingdom)', 'code' => 'en-GB'],
        ['language' => 'English (India)', 'code' => 'en-IN'],
        ['language' => 'English (Ireland)', 'code' => 'en-IE'],
        ['language' => 'English (Kenya)', 'code' => 'en-KE'],
        ['language' => 'English (New Zealand)', 'code' => 'en-NZ'],
        ['language' => 'English (Nigeria)', 'code' => 'en-NG'],
        ['language' => 'English (Philippines)', 'code' => 'en-PH'],
        ['language' => 'English (Singapore)', 'code' => 'en-SG'],
        ['language' => 'English (South Africa)', 'code' => 'en-ZA'],
        ['language' => 'English (Tanzania)', 'code' => 'en-TZ'],
        ['language' => 'English (United States)', 'code' => 'en-US'],
        ['language' => 'Spanish (Argentina)', 'code' => 'es-AR'],
        ['language' => 'Spanish (Bolivia)', 'code' => 'es-BO'],
        ['language' => 'Spanish (Chile)', 'code' => 'es-CL'],
        ['language' => 'Spanish (Colombia)', 'code' => 'es-CO'],
        ['language' => 'Spanish (Costa Rica)', 'code' => 'es-CR'],
        ['language' => 'Spanish (Ecuador)', 'code' => 'es-EC'],
        ['language' => 'Spanish (El Salvador)', 'code' => 'es-SV'],
        ['language' => 'Spanish (Spain)', 'code' => 'es-ES'],
        ['language' => 'Spanish (United States)', 'code' => 'es-US'],
        ['language' => 'Spanish (Guatemala)', 'code' => 'es-GT'],
        ['language' => 'Spanish (Honduras)', 'code' => 'es-HN'],
        ['language' => 'Spanish (Mexico)', 'code' => 'es-MX'],
        ['language' => 'Spanish (Nicaragua)', 'code' => 'es-NI'],
        ['language' => 'Spanish (Panama)', 'code' => 'es-PA'],
        ['language' => 'Spanish (Paraguay)', 'code' => 'es-PY'],
        ['language' => 'Spanish (Peru)', 'code' => 'es-PE'],
        ['language' => 'Spanish (Puerto Rico)', 'code' => 'es-PR'],
        ['language' => 'Spanish (Dominican Republic)', 'code' => 'es-DO'],
        ['language' => 'Spanish (Uruguay)', 'code' => 'es-UY'],
        ['language' => 'Spanish (Venezuela)', 'code' => 'es-VE'],
        ['language' => 'Basque (Spain)', 'code' => 'eu-ES'],
        ['language' => 'Filipino (Philippines)', 'code' => 'fil-PH'],
        ['language' => 'French (Canada)', 'code' => 'fr-CA'],
        ['language' => 'French (France)', 'code' => 'fr-FR'],
        ['language' => 'Galician (Spain)', 'code' => 'gl-ES'],
        ['language' => 'Georgian (Georgia)', 'code' => 'ka-GE'],
        ['language' => 'Gujarati (India)', 'code' => 'gu-IN'],
        ['language' => 'Croatian (Croatia)', 'code' => 'hr-HR'],
        ['language' => 'Zulu (South Africa)', 'code' => 'zu-ZA'],
        ['language' => 'Icelandic (Iceland)', 'code' => 'is-IS'],
        ['language' => 'Italian (Italy)', 'code' => 'it-IT'],
        ['language' => 'Javanese (Indonesia)', 'code' => 'jv-ID'],
        ['language' => 'Kannada (India)', 'code' => 'kn-IN'],
        ['language' => 'Khmer (Cambodia)', 'code' => 'km-KH'],
        ['language' => 'Lao (Laos)', 'code' => 'lo-LA'],
        ['language' => 'Latvian (Latvia)', 'code' => 'lv-LV'],
        ['language' => 'Lithuanian (Lithuania)', 'code' => 'lt-LT'],
        ...
        ['language' => 'Nepali (Nepal)', 'code' => 'ne-NP'],
        ['language' => 'Norwegian Bokmål (Norway)', 'code' => 'nb-NO'],
        ...
        ['language' => 'Sinhala (Sri Lanka)', 'code' => 'si-LK'],
        ['language' => 'Slovak (Slovakia)', 'code' => 'sk-SK'],
        ['language' => 'Slovenian (Slovenia)', 'code' => 'sl-SI'],
        ['language' => 'Sundanese (Indonesia)', 'code' => 'su-ID'],
        ...
        ['language' => 'Tamil (Singapore)', 'code' => 'ta-SG'],
        ['language' => 'Tamil (Sri Lanka)', 'code' => 'ta-LK'],
        ['language' => 'Tamil (Malaysia)', 'code' => 'ta-MY'],
        ['language' => 'Telugu (India)', 'code' => 'te-IN'],
        ['language' => 'Vietnamese (Vietnam)', 'code' => 'vi-VN'],
        ['language' => 'Turkish (Turkey)', 'code' => 'tr-TR'],
        ['language' => 'Urdu (Pakistan)', 'code' => 'ur-PK'],
        ['language' => 'Urdu (India)', 'code' => 'ur-IN'],
        ['language' => 'Greek (Greece)', 'code' => 'el-GR'],
        ['language' => 'Bulgarian (Bulgaria)', 'code' => 'bg-BG'],
        ['language' => 'Russian (Russia)', 'code' => 'ru-RU'],
        ['language' => 'Serbian (Serbia)', 'code' => 'sr-RS'],
        ['language' => 'Ukrainian (Ukraine)', 'code' => 'uk-UA'],
        ['language' => 'Hebrew (Israel)', 'code' => 'he-IL'],
        ['language' => 'Arabic (Israel)', 'code' => 'ar-IL'],
        ['language' => 'Arabic (Jordan)', 'code' => 'ar-JO'],
        ['language' => 'Arabic (United Arab Emirates)', 'code' => 'ar-AE'],
        ['language' => 'Arabic (Bahrain)', 'code' => 'ar-BH'],
        ['language' => 'Arabic (Algeria)', 'code' => 'ar-DZ'],
        ['language' => 'Arabic (Saudi Arabia)', 'code' => 'ar-SA'],
        ['language' => 'Arabic (Iraq)', 'code' => 'ar-IQ'],
        ['language' => 'Arabic (Kuwait)', 'code' => 'ar-KW'],
        ['language' => 'Arabic (Morocco)', 'code' => 'ar-MA'],
        ['language' => 'Arabic (Tunisia)', 'code' => 'ar-TN'],
        ['language' => 'Arabic (Oman)', 'code' => 'ar-OM'],
        ['language' => 'Arabic (State of Palestine)', 'code' => 'ar-PS'],
        ['language' => 'Arabic (Qatar)', 'code' => 'ar-QA'],
        ['language' => 'Arabic (Lebanon)', 'code' => 'ar-LB'],
        ['language' => 'Arabic (Egypt)', 'code' => 'ar-EG'],
        ['language' => 'Persian (Iran)', 'code' => 'fa-IR'],
        ['language' => 'Hindi (India)', 'code' => 'hi-IN'],
        ['language' => 'Thai (Thailand)', 'code' => 'th-TH'],
        ['language' => 'Korean (South Korea)', 'code' => 'ko-KR'],
        ['language' => 'Chinese, Mandarin (Traditional, Taiwan)', 'code' => 'zh-TW'],
        ['language' => 'Chinese, Cantonese (Traditional, Hong Kong)', 'code' => 'yue-Hant-HK'],
        ['language' => 'Japanese (Japan)', 'code' => 'ja-JP'],
        ['language' => 'Chinese, Mandarin (Simplified, Hong Kong)', 'code' => 'zh-HK'],
        ['language' => 'Chinese, Mandarin (Simplified, China)', 'code' => 'zh'],
    ],
];
